...
- **p-min 0.50 is now the server default** (+10% decode, same answers); `PMIN=0.75` on
  the server side restores the old threshold if a workload ever shows lower acceptance.
